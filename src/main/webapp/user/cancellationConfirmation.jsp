...
<head>
    ...
    <title>Marry Mate - Cancellation Confirmation</title>
    ...
    <style>
        ...
        /* Style the cancellation section with a wedding-themed background */
...
<body>
    ...
    <!-- Cancellation Confirmation Section: Displays cancellation and refund details -->
    <section class="cancellation-section">
        <div class="container">
            <h2 class="text-center mb-4">Cancellation Confirmation</h2>
            <div class="card">
                <div class="card-body text-center">
                    <h3>Cancellation Successful!</h3>
                    <!-- Display message and refund amount set by BookingServlet -->
