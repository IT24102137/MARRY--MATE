...
<head>
    ...
    <title>Marry Mate - Payment Status</title>
    ...
    <style>
        ...
        /* Style the status section with a wedding-themed background */
        .status-section {
...
<body>
    ...
    <!-- Payment Status Section: Displays the status of a payment -->
    <section class="status-section">
        <div class="container">
            <h2 class="text-center mb-4">Payment Status</h2>
            <div class="card">
                <div class="card-body text-center">
                    <!-- Display booking ID from query parameter and status from PaymentServlet -->
                    <p><strong>Booking ID:</strong> ${param.bookingId}</p>
